  ...
  template: `
    <div class="min-h-screen bg-dark-gradient flex items-center justify-center p-4">
      <div class="absolute inset-0 overflow-hidden pointer-events-none">
        <div class="absolute top-1/4 right-1/4 w-96 h-96 bg-blue-600 opacity-5 rounded-full blur-3xl"></div>
        <div class="absolute bottom-1/3 left-1/4 w-64 h-64 bg-blue-500 opacity-5 rounded-full blur-3xl"></div>
      </div>
          ...
          <div class="space-y-4">
            ...
            <div>
              ...
              <div class="flex gap-2">
                <div class="input-field w-16 text-center flex-shrink-0 text-slate-400">+91</div>
            ...
            <label class="flex items-start gap-2 text-sm text-slate-400 cursor-pointer">
